...
# Ensure all category values are strings and handle missing values
_clean_categories = books["categories"].fillna("Unknown").astype(str)
categories = ["All"] + sorted(_clean_categories.unique())
